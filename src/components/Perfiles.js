...
const Perfiles = (props) => {
  ...
  return(
    <div> 
        ...
        <h1>Mis mascotas:</h1>
        <div className="Container" onClick={()=>history.push("/Sesion")}>
            ...
            <button className="info-hobby5" onClick={() => history.push("/Perros")}>       
             <img src="./img/signomas.png" class="card-img-top" alt="..." />
            </button>
